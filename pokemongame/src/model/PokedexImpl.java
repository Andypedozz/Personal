...
public class PokedexImpl implements Pokedex{
	...
	public PokedexImpl() {
		...
		Pokemon lucario = new PokemonImpl("Lucario", Arrays.asList(Type.LOTTA, Type.ACCIAIO) , lucarioStats, lucarioMoveset.duplicate(), "icons/lucario.png");
		Pokemon infernape = new PokemonImpl("Infernape", Arrays.asList(Type.FUOCO, Type.LOTTA), infernapeStats, infernapeMoveset.duplicate(), "icons/infernape.png");
		Pokemon blissey = new PokemonImpl("Blissey", Arrays.asList(Type.NORMALE) , blisseyStats, blisseyMoveset.duplicate(), "icons/blissey.png");
		Pokemon staraptor = new PokemonImpl("Staraptor", Arrays.asList(Type.NORMALE, Type.VOLANTE), staraptorStats, staraptorMoveset.duplicate(), "icons/staraptor.png");
		Pokemon zoroark = new PokemonImpl("Zoroark", Arrays.asList(Type.BUIO) , zoroarkStats, zoroarkMoveset.duplicate(), "icons/zoroark.png");
		Pokemon swampert = new PokemonImpl("Swampert", Arrays.asList(Type.ACQUA, Type.TERRA), swampertStats, swampertMoveset.duplicate(), "icons/swampert.png");
		Pokemon blaziken = new PokemonImpl("Blaziken", Arrays.asList(Type.FUOCO, Type.LOTTA), blazikenStats, blazikenMoveset.duplicate(), "icons/blaziken.png");
		Pokemon salamence = new PokemonImpl("Salamence", Arrays.asList(Type.DRAGO, Type.VOLANTE), salamenceStats, salamenceMoveset.duplicate(), "icons/salamence.png");
		Pokemon luxray = new PokemonImpl("Luxray", Arrays.asList(Type.ELETTRO), luxrayStats, luxrayMoveset.duplicate(), "icons/luxray.png");
		Pokemon metagross = new PokemonImpl("Metagross", Arrays.asList(Type.ACCIAIO, Type.PSICO), metagrossStats, metagrossMoveset.duplicate(), "icons/metagross.png");

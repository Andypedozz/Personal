...
public class InfoPanel2 extends JPanel{
	...
	public InfoPanel2(ViewObserver observer) {
	...
	public void loadInfo(Pokemon pokemon) {
		...
		moveDesc[1].setText(pokemon.getMoveSet().getMove1().getDescription());
		moveDesc[2].setText(pokemon.getMoveSet().getMove1().getDescription());
		moveDesc[3].setText(pokemon.getMoveSet().getMove1().getDescription());
